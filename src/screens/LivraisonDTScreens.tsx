...
const LivraisonDTScreens = ({ route }: { route: any }) => {
  ...
  const [tableData, setTableData] = useState([
    {id: 100, article: 'JUTOS ORG 150', disponible: 150, qty: 150, perte: 0, prix: 15.5, promo: 30,total: 0,totalpromo:0},
    {id: 101, article: 'JUTOS MANG 150 ', disponible: 150, qty: 150, perte: 0, prix: 10.7, promo: 30,total: 0,totalpromo:0},
    {id: 103, article: 'JUTOS MANG 150 ', disponible: 150, qty: 150, perte: 0, prix: 10.7, promo: 30,total: 0,totalpromo:0},
    {id: 104, article: 'JUTOS MANG 150 ', disponible: 150, qty: 150, perte: 0, prix: 10.7, promo: 30,total: 0,totalpromo:0},
    {id: 105, article: 'JUTOS MANG 150 ', disponible: 150, qty: 150, perte: 0, prix: 10.7, promo: 30,total: 0,totalpromo:0},
    ...
    setTableData(prevData => {
      const newData = prevData.map(item =>
        item.id === index
          ? {
            ...item,
            qty: item.disponible - item.perte
          }
          : item
      );
    ...
    setTableData(prevData => {
      const newData = prevData.map(item =>
        item.id === index
          ? {
            ...item,
            perte: item.disponible - item.qty
          }
          : item
      );
  ...
  return (
    ...
    >
      ...
      <View style={styles.headerContainer_f}>
        ...
        <Text style={[styles.headerText_2]}>CMD</Text>
        <Text style={[styles.headerText_3]} onPress={sortData}>QTY</Text>
        <Text style={[styles.headerText_4]} >RETOUR</Text>
      </View>
...
export default LivraisonDTScreens;
