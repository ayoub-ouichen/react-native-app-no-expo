  ...
  return (
    ...
    >
      ...
      <View style={styles.header}>
        ...
        <Text style={styles.headerTitle}>COMMANDE SECTEUR</Text>
        ...
        <View style={{
          ...
          <View style={{alignItems: 'flex-start', marginBottom: 50, marginLeft: 10}}>
            <Text style={styles.connectButtonText}>
              Valeur charge : <Text
              style={[styles.rowfooter, {fontWeight: 'bold'}]}>{total.toFixed(2)}</Text> MAD
            </Text>
          </View>
...
export default CommandeSecteurScreens;
