...
import {
  ...
  Platform,
  TouchableOpacity, AppState, Modal, Easing, Animated
} from 'react-native';
import {KeyboardAwareScrollView} from "react-native-keyboard-aware-scroll-view";
import {NavigationProp, useNavigation} from '@react-navigation/native';
import {RootStackParamList} from '../Types/types.ts';

const FacturesScreens: React.FC = () => {
  ...
  const [tableData, setTableData] = useState([
    {clientName: 'EL KAMALI AHMED', total: '5', matricule: '5050429', tournee: 'true'},
    {clientName: 'EL KAMALI AHMED', total: '5', matricule: '5050429', tournee: 'true'},
    {clientName: 'EL KAMALI AHMED', total: '5', matricule: '5050429', tournee: 'true'},
    {clientName: 'EL KAMALI AHMED', total: '5', matricule: '5050429', tournee: 'true'},
    {clientName: 'EL KAMALI AHMED', total: '5', matricule: '5050429', tournee: 'true'},
    ...
    >
      ...
      <View style={styles.container}>
        ...
        <View style={styles.header}>
          ...
          <Text style={styles.headerTitle}>LISTE FACTURES</Text>
        </View>
...
export default FacturesScreens;
